...
TELEGRAM_BOT_TOKEN = '7596367754:AAEfWhMtiwdlFkrvByg5W076MMC4UWYqFzE'
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        ...
        "*🔗JOIN:- https://t.me/KaluaytOfficial*"
